            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 div-checks">
                        ...
                        <div class="row">
                            <h4 class="card-title" style="font-size: 22px;">Adicionando novo produto para {{$startup->nome}}</h5>
                        </div>
                    </div>
                            ...
                            <div class="container" style="margin-top: 15px; margin-bottom: 15px;">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <input id="titulo" name="título" type="text" class="form-control @error('título') is-invalid @enderror" placeholder="Digite o título do produto aqui..." required value="{{old('título')}}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="descricao" name="descrição" class="form-control @error('descrição') is-invalid @enderror" placeholder="Forneça uma breve descrição do seu produto..." required>{{old('descrição')}}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div style="display: none;">
                                                <input id="video_input" name="vídeo_do_pitch" type="file" class="form-control @error('vídeo_do_pitch') is-invalid @enderror" accept=".mp4, .mkv">
                                            </div>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-12" onclick="click_file_input()">
                                                <div class="card card-click">
                                                    <div class="card-body">
                                                        <div style="text-align: center;">
                                                            <img id="input-profile-photo-retangular" src="{{asset('img/img.svg')}}" alt="Imagem default perfil" style="width: 100%; height: 80px; max-width: 100%; max-height: 80px;">
                                                        </div>
                                            ...
                                            <div style="display: none;">
                                                <input id="thumbnail" name="thumbnail" type="file" class="form-control @error('thumbnail') is-invalid @enderror" accept=".png, .jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
