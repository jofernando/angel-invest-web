                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12" style="text-align: right;">
                                        ...
                                        <button class="btn btn-danger btn-padding border" data-bs-toggle="modal" data-bs-target="#moda-delete-proposta-{{$proposta->id}}"> <img src="{{asset('img/trash-white.svg')}}" alt="Icone de editar proposta" style="height: 20px;"> Deletar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
