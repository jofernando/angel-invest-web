        ...
        <div class="card card-feature">
            <div class="card-body bg-azul px-0 pt-1 flex flex-wrap">
                ...
                <div id="formulario" class="mb-9 mt-2 px-0 bg-fundo md:w-3/4 w-full">
                    <form action="{{route('leiloes.lances.update', ['leilao' => $leilao, 'lance' => $lance])}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mx-10 mt-12 pt-3">
                            <h2>Alterando o lance para o leilão do produto {{ $leilao->proposta->startup->nome }}</h2>
